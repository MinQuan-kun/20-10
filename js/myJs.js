const textConfig = {
  ...
  text4: "Ngày hôm nay không bông hoa nào đẹp hơn các bạn đâu <3 Chúc các bạn nữ ngày hôm nay luôn tươi tắn, xinh đẹp và tràn đầy năng lượng, mong những điều tốt đẹp nhất sẽ đến với cậu💖!, Hãy chọn cho mình 1 điều ước nhé🐧 ",
...
$(document).ready(function () {
  ...
  function switchButton() {
    var audio = new Audio("Heybabe/duck.mp3");
    audio.play();
  ...
  function moveButton() {
    var audio = new Audio("Heybabe/Swish1.mp3");
    audio.play();
    if (screen.width <= 600) {
  ...
  // show popup
  $("#yes").click(function () {
    var audio = new Audio("Heybabe/tick.mp3");
    audio.play();
    Swal.fire({
